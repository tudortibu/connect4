...
def main(train_path,  test_path, epoch=15, valpath=None, save_weights=False):
    ...
    if (save_weights):
        model.save("Weights/MLP_Weights/shuffled/model")
        np.savetxt("Weights/MLP_Weights/shuffled/pred_pb.csv",pred_nn_prob)
        np.savetxt("Weights/MLP_Weights/shuffled/pred_class.csv",pred_nn_class)
        np.savetxt("Weights/MLP_Weights/shuffled/true_class.csv", test_tt)
        np.savetxt("Weights/MLP_Weights/shuffled/true2_class.csv", test_t)
